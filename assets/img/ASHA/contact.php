...
<html lang="en">
  <head>
    <!-- Basic -->
    <title>
      Asha Solar Power Solutions - Contact Us
    </title>
    <!-- Define Charset -->
    <meta charset="utf-8">
    <!-- Responsive Metatag -->
    ...
    <meta name="description" content="Asha Solar">
    <meta name="author" content="Asha Solar">
  ...
  (function(d, s, id){
              ...
              <div class="col-md-7 col-sm-9">
                ...
                <ul class="contact-details">
                  ...
                  <li>
                    ...
                    Call Us: <span class="number">+91-9446950001</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
            ...
            <div class="col-md-5 col-md-offset-1">
              ...
              <div class="information">
                <div class="contact-datails">
                  ...
                  <div class="info">
                    <h3>Address</h3>
                    <span class="detail">Main Office: Bus Stand Building, Kondotty, Malappuram.</span>
                    <span class="datail">Pin:673638.</span>
                  </div>
                </div>                
                <div class="contact-datails">
                  <div class="icon">
                  ...
                  <div class="info">
                    <h3>Phone Numbers</h3>
                    <span class="detail">Main Office: +919446950001</span>
                    <span class="datail">Customer Supprort: +919446950002, +918547056111</span>
                  </div>
                </div>
                <div class="contact-datails">
                  <div class="icon">
                  ...
                  <div class="info">
                    ...
                    Support: abhinash@ashasolar.com</span>
                    <span class="datail">Technical Support: contact@ashasolar.com</span>
                  </div>
                </div>
                <div class="contact-datails">
                  <div class="icon">
                  ...
                  <div class="info">
                    <h3>Other Datails</h3>
                    <span class="detail">Site Name: <a href="http://ashasolar.com/">ashasolar.com</a></span>
                  </div>
                </div>
              </div>
            </div>
    ...
    var map;
    var plain = new google.maps.LatLng(11.0731819, 76.07399989999999);
    var mapCoordinates = new google.maps.LatLng(11.0731819, 76.07399989999999);
